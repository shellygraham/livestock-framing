...
jQuery(function() {
  var $ = jQuery;
	...
	// uploads
  $('#cewip_inline_pages').on( 'click', '.button-upload', function( e ) {
  ...
  $( 'body' ).on( 'change', '.section .title select', function( e ) {
      ...
      $.ajax({
        url: cewip_properties.url + '?action=cewip_get_section_options&post_id=' + cewip_properties.post_id + '&section_name=' + section_id + '&index=' + index,
        cache: true,
        async: false,
        dataType: 'json',
        complete: function( data, status ) {
  ...
  // check if cewip_properties has sections - if so, get 'em!
  if ( typeof cewip_properties.sections != 'undefined' ) {
    var sections = cewip_properties.sections;
    var $sections = $( 'ul.sections' );
    ...
    $.each( sections, function( index, value ) {
      ...
      var new_data = cewip_properties.url_data + '&type=' + section_type + '&id=' + section_id + '&index=' + index;
