			...
			<div class="layout-span12">
				<ul class="breadcrumb">
				    <li>
				        ...
				        <a href="#"><?php _e("System Status", gallery_bank); ?></a>
				    </li>
				</ul>
							...
							<div class="layout-span6">
								...
								<div class="widget-layout">
							        ...
							        <div id="library_settings" class="collapse in">
							            <?php
							            if(!function_exists("gallery_get_gd_settings"))
							            {
							            	function gallery_get_gd_settings($bool)
							            	{
							            		if ($bool)
							            			return "Yes";
							            		else
							            ...
							            if (function_exists("gd_info")) {
							                ...
							                for ($i = 0; $i < count($key); $i++) {
							                    if (is_bool($information[$key[$i]]))
							                        echo "<div class=\"widget-layout-body\"><div class=\"layout-control-group\"><label class=\"layout-label-control-group\">" . $key[$i] . " : </label><div class=\"layout-controls\"> <span>" . gallery_get_gd_settings($information[$key[$i]]) . " </span></div></div></div>";
							                    else
