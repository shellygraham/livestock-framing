...
<div class="albums-in-row_<?php echo $unique_id; ?>" id="view_gallery_bank_albums_<?php echo $unique_id; ?>">
	...
	for ($flag = 0;$flag < count($album);$flag++)
	{
		...
		<div class="albums_margin">
			...
			if ($gallery_type == "slideshow")
			{
				?><div class="imgLiquid dynamic_cover_css" id="<?php echo $unique_id; ?>" onclick="getalbum_id<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)"><?php
			}
			else
			{
				?><div class="imgLiquid dynamic_cover_css" id="<?php echo $unique_id; ?>" onclick="view_album_images<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)"><?php
			}
			...
			<div class="album_holder">
				...
				if ($gallery_type == "slideshow") {
					...
					<div class="album_link">
			 			<a onclick="getalbum_id<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)">
				...
				<?php
					...
					?>
					<div class="album_link">
						<a onclick="view_album_images<?php echo $unique_id; ?>(<?php echo $album[$flag]->album_id; ?>,<?php echo $unique_id; ?>)"><?php echo $album_click_text; ?></a>
					</div>
				<?php
				}
				?>
...
if ($gallery_type == "slideshow") {
	?>
	<div id="bank_slideshow_images_div<?php echo $unique_id; ?>" style="display:none;"></div>
<?php
} else {
	?>
