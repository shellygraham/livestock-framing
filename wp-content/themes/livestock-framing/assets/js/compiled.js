...
Heyoffline = (function() {
  ...
  Heyoffline.prototype.options = {
    text: {
      ...
      content: "We can't detect an internet connection. You might want to wait until your network comes back before continuing.<br /><br />This message will go away once you're online again.",
...
/*>>fastclick*/
 _checkInstance(); }));;/*! jQuery TubePlayer - v1.1.6 - 2013-06-04
