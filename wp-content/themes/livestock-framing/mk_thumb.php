...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '../../uploads');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! isset($ALLOWED_SITES)){
	$ALLOWED_SITES = array (
		...
		'tinypic.com',
		'fpoimg.com',
		'secure-b.vimeocdn.com',
		'static.cleanenergyworks.dev',
		'static.cleanenergyworks.gbsandbox.com',
		'static.cleanenergyworksoregon.org',
